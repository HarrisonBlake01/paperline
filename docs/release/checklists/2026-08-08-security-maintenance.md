...
- [x] Created clean maintenance branch `security/pdfjs-runtime-hardening-2026-08-08` from current `origin/main` and reproduced the reviewed 281-file manifest exactly.
