...
export const PLANS: Record<PlanId, Plan> = {
  free: {
    ...
    features: [
      ...
      "MCP/API access with your own AI client",
      "(Planned) shared links with Paperline branding",
    ],
  },
  pro: {
    id: "pro",
    ...
    features: [
      ...
      "MCP/API access with your own AI client",
      "(Planned) Google Drive, Dropbox, email-to-inbox",
      "(Planned) priority email support",
      "(Planned) remove Paperline branding",
    ],
  ...
  team: {
    ...
    features: [
      "10,000 pages / month",
      "Unlimited users",
      "MCP/API access with scoped agent credentials",
      "Community template publishing + reuse",
      "250 AI-generated custom templates / month",
      "(Planned) priority processing queue",
      "(Planned) SSO (Google Workspace)",
      "(Planned) audit log export",
    ],
  ...
  enterprise: {
    ...
    features: [
      ...
      "MCP/API access with scoped agent credentials",
      "(Planned) dedicated support",
      "(Planned) DPA / MSA / security review",
      "(Planned) custom SSO + role mapping",
      "(Planned) on-prem deployment discovery",
    ],
  },
};
